function Footer() {
    return ( 
        <footer className="bg-gray-900 dark:bg-gray-900 mt-28">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <div className="flex flex-col items-start">
                        <img src="/images/FoodHaven.png" className="h-20 me-3" alt="FlowBite Logo" />
                        <div className="text-white">
                            <div>100 Quang Trung Street, 12 Ward, Go Vap District, HCMC, Vietnam</div>
                            <div><span className="font-bold">Email: </span>example@gmail.com</div>
                            <div><span className="font-bold">Hotline: </span>(+84) 999 999 999</div>
                        </div>
                    </div>
                </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between text-white text-xs">
                <div>
                    BẢN QUYỀN THUỘC VỀ FOODHAVEN
                </div>
