...
function BodyThankFailure() {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-28">
      <div className="text-3xl font-medium">Lỗi thanh toán</div>
      ...
      <div className="mb-2">
        <img src="/images/pay_err.png" alt="Order confirmation gif" />
      </div>
      <div>
...
export default BodyThankFailure;
