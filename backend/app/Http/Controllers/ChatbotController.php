...
// CÂU HỎI VỀ SẢN PHẨM
        ...
        if (strpos($question, 'sản phẩm bán chạy nhất') !== false) {
        ...
        elseif (strpos($question, 'giá của sản phẩm bán chạy đó') !== false) {
        ...
        elseif (strpos($question, 'sản phẩm bán chạy đó còn hàng không') !== false) {
            $topSellingProductId = $request->session()->get('topSellingProductId');
        ...
        elseif (strpos($question, 'có chương trình khuyến mãi cho sản phẩm bán chạy này không') !== false) {
            $topSellingProductId = $request->session()->get('topSellingProductId');
        ...
        elseif (strpos($question, 'sản phẩm đó có được bảo hành không') !== false) {
            $topSellingProductId = $request->session()->get('topSellingProductId');
        ...
        elseif (strpos($question, 'cách sử dụng sản phẩm như thế nào') !== false) {
            $topSellingProductId = $request->session()->get('topSellingProductId');
        ...
        elseif (strpos($question, 'sản phẩm nổi bật nhất') !== false) {
        ...
        elseif (strpos($question, 'giá của sản phẩm') !== false) {
        ...
        elseif (strpos($question, 'sản phẩm còn hàng không') !== false) {
            // Lấy danh sách các sản phẩm nổi bật đã lưu trong session
            $bestProductIds = $request->session()->get('bestProductIds');
        ...
        elseif (strpos($question, 'sản phẩm có nằm trong flashsale không') !== false) {
            // Lấy danh sách các sản phẩm nổi bật đã lưu trong session
            $bestProductIds = $request->session()->get('bestProductIds');
        ...
        elseif (strpos($question, 'sản phẩm flashsale') !== false) {
        ...
        elseif (strpos($question, 'sản phẩm mới') !== false) {
        ...
        elseif (strpos($question, 'những sản phẩm giá rẻ nhất') !== false) {
...
// CÂU HỎI VỀ ĐƠN HÀNG
        elseif (strpos($question, 'tra cứu đơn hàng') !== false) {
            $answer = 'Đường dẫn để tra cứu đơn hàng là: https://haven-gold.vercel.app/tracking';
        } 
        elseif (strpos($question, 'tôi có thể hủy đơn hàng không') !== false) {
        ...
        elseif (strpos($question, 'có thể mua lại đơn hàng đã mua không') !== false) {
            $answer = ' Hiện tại trang web chúng tôi đang cập nhật tính năng trên ! ';
        } 
        elseif (strpos($question, 'làm sao để xem lịch sử mua hàng') !== false) {
            $answer = ' Vào phần tài khoản cá nhân của bạn, kích vào mục quản lí đơn hàng để xem ! ';
        } 
// KẾT THÚC VỀ ĐƠN HÀNG

// CÂU HỎI VỀ GIAO HÀNG
        elseif (strpos($question, 'khi nào tôi sẽ nhận được hàng') !== false) {
            $answer = ' Thời gian giao hàng dự kiến : 5 ngày làm việc ! ';
        } 
        elseif (strpos($question, 'phí vận chuyển là bao nhiêu') !== false) {
            $answer = ' Free Ship TP.HCM, còn lại đồng giá ship 30k ! ';
        } 
        elseif (strpos($question, 'làm sao để kiểm tra trạng thái đơn hàng của tôi') !== false) {
...
// BẮT ĐẦU VÊ THANH TOÁN
        elseif (strpos($question, 'có những phương thức thanh toán nào') !== false) {
            $answer = ' Chúng tôi có 2 phương thức thanh toán : COD và VNPay ! ';
        } 
        elseif (strpos($question, 'có những phương thức thanh toán nào') !== false) {
            $answer = ' Chúng tôi có 2 phương thức thanh toán : COD và VNPay ! ';
        } 
        elseif (strpos($question, 'có chương trình tích điểm hoặc giảm giá khi thanh toán không') !== false) {
